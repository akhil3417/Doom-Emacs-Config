...
(use-package! embark
  ...
  (eval-when-compile
    ...
    ;;
    ;;added after new update when embark-define-keymap become old
(defvar this-buffer-file-map (make-sparse-keymap)
  "Commands to act on current file or buffer.")
(define-key this-buffer-file-map (kbd "l") 'load-file)
(define-key this-buffer-file-map (kbd "b") 'byte-compile-file)
(define-key this-buffer-file-map (kbd "S") 'sudo-find-file)
(define-key this-buffer-file-map (kbd "r") 'rename-file-and-buffer)
(define-key this-buffer-file-map (kbd "d") 'my/diff-buffer-dwim)
(define-key this-buffer-file-map (kbd "=") 'ediff-buffers)
(define-key this-buffer-file-map (kbd "C-=") 'ediff-files)
(define-key this-buffer-file-map (kbd "!") 'shell-command)
(define-key this-buffer-file-map (kbd "&") 'async-shell-command)
(define-key this-buffer-file-map (kbd "x") 'consult-file-externally)
(define-key this-buffer-file-map (kbd "C-a") 'mml-attach-file)
(define-key this-buffer-file-map (kbd "c") 'copy-file)
(define-key this-buffer-file-map (kbd "k") 'kill-buffer)
(define-key this-buffer-file-map (kbd "#") 'recover-this-file)
(define-key this-buffer-file-map (kbd "z") 'bury-buffer)
(define-key this-buffer-file-map (kbd "|") 'embark-shell-command-on-buffer)
(define-key this-buffer-file-map (kbd "U") '0x0-dwim)
(define-key this-buffer-file-map (kbd "g") 'revert-buffer)
(set-keymap-parent this-buffer-file-map embark-general-map)
